...
define(function( require, exports, module ){
    ...
    base.inherit(Game, DisplayObjectContainer);
     ...
     * onstop 停止游戏
     */
    Game.prototype.onstart = base.fn;
    Game.prototype.onstop = base.fn;
    ...
    Game.prototype.__run = function() {
        ...
        this.__timeout = setTimeout(base.delegate(this.__run, this), this.__sleep);
